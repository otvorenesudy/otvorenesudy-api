...
#
class Judge::Property < OpenCourts::ApplicationRecord
  belongs_to :list, class_name: 'Judge::Property::List', foreign_key: :judge_property_list_id
  belongs_to :acquisition_reason,
             class_name: 'Judge::Property::AcquisitionReason',
             foreign_key: :judge_property_acquisition_reason_id
  belongs_to :ownership_form,
             class_name: 'Judge::Property::OwnershipForm',
