...
module InfoSud
  ...
  def self.import_courts
    import(InfoSud::Downloader.download_file(COURTS_URL), repository: InfoSud::Court)
  end

  def self.import_judges
    import(InfoSud::Downloader.download_file(JUDGES_URL), repository: InfoSud::Judge)
  end

  def self.import_hearings
    import(InfoSud::Downloader.download_file(HEARINGS_URL), repository: InfoSud::Hearing)
  end

  def self.import_decrees
    import(InfoSud::Downloader.download_file(DECREES_URL), repository: InfoSud::Decree)
  end
