  ...
  class ItemParser
    def self.parse(html)
...

      {
        ...
        datum_vydania_rozhodnutia: detail.css('.contentTable tr')[2].at_css('td').text.strip.presence,
        ...
        povaha_rozhodnutia: detail.css('.contentTable tr')[7].at_css('td').text.strip.presence,
