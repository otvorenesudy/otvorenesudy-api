...
RSpec.describe ObcanJusticeSk::Hearings::ResourceParser do
  ...
  describe '.parse' do
    it 'parses hearing', vcr: { cassette_name: 'obcan_justice_sk/hearing' } do
      attributes = ObcanJusticeSk::Hearings::ResourceParser.parse(html)
    ...
    context 'when judge is missing' do
      ...
      it 'correcly parses hearing', vcr: { cassette_name: 'obcan_justice_sk/hearing_without_judge' } do
        attributes = ObcanJusticeSk::Hearings::ResourceParser.parse(html)
